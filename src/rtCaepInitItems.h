...
#define ID_NUC3d  20
{
    ...
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "NUC3d",             /* const char *name */
        MAKEGUID(ID_NUC3d),  /* PWP_UINT32 id */
    ...
    NUC3dBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(NUC3dBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    NUC3dVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(NUC3dVCInfo), /* PWP_UINT32 VCCnt */
